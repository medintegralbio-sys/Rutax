...
import { AdminCoopDashboard } from '../AdminCoopDashboard';
import { rutaxStore } from '../../services/store';
import { LogOut } from 'lucide-react';
import { UnitEnrollmentModal } from '../UnitEnrollmentModal';

export const LayoutAdminCoop = () => {
    ...
    <div className="relative min-h-screen bg-slate-950 text-slate-100 font-sans">
      <header className="bg-slate-900 border-b border-slate-800 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-slate-300">Administración de Cooperativa</span>
        </div>
        <button
      ...
      <main className="w-full bg-slate-950 p-4 md:p-6 pb-12">
        <AdminCoopDashboard onOpenUnitEnrollment={() => setShowEnrollModal(true)} />
      </main>
